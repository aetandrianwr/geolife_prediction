"""
Train advanced next-location prediction model.

This script uses state-of-the-art techniques to maximize performance:
...
from src.models.advanced_model import AdvancedLocationModel
...
def parse_args():
    ...
    parser.add_argument('--config', type=str, default='configs/advanced.yml',
...
def main():
    ...
    if num_params >= 500000:
        ...
        raise ValueError(f"Model exceeds parameter budget: {num_params:,} >= 500,000")
    else:
    ...
    trainer = AdvancedTrainer(
        ...
        swa_start=config.training.get('swa_start', 150),
        swa_lr=config.training.get('swa_lr', 5e-5)
    )
